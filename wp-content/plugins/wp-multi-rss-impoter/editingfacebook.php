...
<?php
            ...
            if( 'POST' == $_SERVER['REQUEST_METHOD'] && isset($_POST['submit'])) {
						...
						if(!empty($_POST['title']))
						{
								...
								$url='https://graph.facebook.com/search?q='.strtolower(trim($_POST['title'])).'&type=post';
        ...
        <div class="wrap">
            ...
            <div id="wpbody-content">
                <div class="wrap">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']."?page=addingfacebook&action=edit&id=".$ID; ?>" enctype="multipart/form-data" method="post" name="editFrmPlan" id="editFrmPlan">
